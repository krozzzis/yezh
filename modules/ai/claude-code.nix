...
delib.module {
  ...
  options = { myconfig, ... }: {
    ai.claude-code.enable = delib.boolOption myconfig.gui.enable;
  };
  ...
  home.ifEnabled = { myconfig, ... }:
    let
      ...
      enabledLsp = lib.filterAttrs (_name: srv: srv.enable && srv.package != null) myconfig.dev.lsp;
      enabledMcp = lib.filterAttrs (_name: srv: srv.enable) myconfig.dev.mcp;
