{ delib, lib, pkgs, ... }:
delib.module {
  name = "yezh.system.autoClean";

  options = { myconfig, ... }: {
    yezh.system.autoClean.enable = delib.boolOption true;
    yezh.system.autoClean.keepGenerations = delib.description (delib.intOption 4) "Number of system/home-manager generations to keep";
  };
