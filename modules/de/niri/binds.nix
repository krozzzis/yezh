    ...
    programs.niri.settings = {
      binds = {
        "Mod+Return" = {
          ...
          action.spawn = [
            (lib.getName myconfig.terminal.default.pkg)
          ];
        };
        ...
        "Mod+P" = {
          ...
          action.spawn = [
            (lib.getName myconfig.de.niri.launcher.default.pkg)
          ];
        };
        ...
        "Mod+E" = {
          ...
          action.spawn = [
            (lib.getName myconfig.fileManager.default.pkg)
          ];
        };
        ...
        "Mod+Ctrl+L" = {
          ...
          action.spawn = [
            (lib.getName myconfig.browser.default.pkg)
          ];
        };
